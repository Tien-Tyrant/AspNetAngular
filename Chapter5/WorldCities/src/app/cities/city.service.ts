...
export class CityService extends BaseService<City> {
  ...
  getData(pageIndex: number, pageSize: number, sortCollumn: string, sortOrder: string, filterColumn: string | null, filterQuery: string | null): Observable<ApiResult<City>> {
